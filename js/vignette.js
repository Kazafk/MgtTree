...
export function generateVignette(categorie, size = 64) {
  ...
  return `<svg viewBox="0 0 ${size} ${size}" width="${size}" height="${size}" xmlns="http://www.w3.org/2000/svg" class="vignette vignette--${categorie}">` +
