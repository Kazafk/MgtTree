...
const a = generateVignette('industriel', 48);
...
const b = generateVignette('agile', 48);
...
assertThrows(() => generateVignette('inconnue'), 'doit rejeter une categorie non supportée');
